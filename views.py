...
def StudentCreate(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            s = form.cleaned_data &  # 91;'roll_no']
            form.save()
...
def normalize_query(query_string,
    ...
    '''
    return &  # 91;normspace(' ', (t&#91;0] or t&#91;1]).strip()) for t in findterms(query_string)]
    ...
    def search_book(request):
        query_string = ''
        found_entries = None
        if ('q' in request.GET) and request.GET &  # 91;'q'].strip():
            query_string = request.GET &  # 91;'q']

            entry_query = get_query(query_string, &  # 91;'title', 'summary','author'])
    ...
    def search_student(request):
        ...
        if ('q' in request.GET) and request.GET &  # 91;'q'].strip():
            ...
            entry_query = get_query(query_string, &  # 91;'roll_no','name','email'])
